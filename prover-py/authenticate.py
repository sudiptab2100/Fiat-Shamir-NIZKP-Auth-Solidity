...
k = contract.functions.get_k(sender_address).call()
proof = generate_proof(password, k)
print(f"k: {k}\nProof: {proof}")
set_commitment_tx = contract.functions.authenticate(sender_address, proof['t'], proof['r']).build_transaction(
    {
